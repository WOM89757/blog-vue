  ...
  <el-row class="music-row">
    ...
    height: 100%;">
          ...
          <div class="cont-cont">
            ...
            >&#xe636;</span>
            <span @click="pause" class="cont-itme iconfont">{{isPlay?'&#xe639;':'&#xe634'}}</span>
            <span
              class="cont-itme iconfont"
  ...
  data() {
    ...
    //   ],
      musics: [
        {
            "music_id": "1474400749",
            "title": "The Way I Still Love You（纯音乐）（翻自 Reynard Silva）",
            "name": "阿涵",
            "type": "netease",
            "url":'https://music.163.com/song/media/outer/url?id=1474400749.mp3',
            "pic":'http://p2.music.126.net/wcrpX_WdBBfIbtigBEvvbQ==/109951165115690496.jpg?param=300x300'
        },
        {
            "music_id": "1436709403",
            "title": "夏天的风",
            ...
            "pic":'http://p3.music.126.net/rFUKVdOjqxgwAT6Zi6qv7A==/109951164906689206.jpg?param=300x300'
        }, 
        {
            "music_id": "1463165983",
            "title": "最美的期待",
  ...
  methods: {
    ...
    getMusic() {
        ...
        this.musicInfo = {
            ...
            pic: this.musics[this.index].pic,
